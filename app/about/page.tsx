...
const BIO_PARAGRAPHS: string[] = [
  ...
  "My work runs through schools, mental health and behavioral programs, and grant-funded mission-driven organizations — across modern data platforms, measurement, analytics, and the operating rhythms that turn signal into action. I step into complex environments, deliver early value, and build toward scalable systems with stronger decision discipline — from data foundations to the narratives executives and frontline operators can act on.",
