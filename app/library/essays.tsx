    ...
    body: (
      <>
        <Brief>
          ...
          <p>
            A measurement function has four jobs. The first is to design what to collect, against the claims it will have to support. The second is to analyse so the people running the programme can act this month. The third is to analyse so a funder gets a claim they can check. The fourth is to revise the measurement for the next round. The fourth feeds the first, and a reporting function never runs it.
          </p>
          <p>
            I have held that seat in four organisations, and each placement broke the loop in a different place. This note is about what breaks, which split does the breaking, and what to ask of a requisition or a grantee to find out.
          </p>
        </Brief>
