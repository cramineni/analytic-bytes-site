  ...
  // ===================================================================
  {
    ...
    body: (
      <>
        ...
        <P>
          There is a mature field that already solved a version of this &mdash; in testing. For more than thirty years, high-stakes assessment has treated a decision as a chain of inferences to be examined link by link (Kane, 1992: validation as an argument, with evidence aimed at the weakest assumption), and has insisted that validity is a property of the <I>use</I> of a number, consequences included, not of the number itself (Messick, 1989: unified construct validity). Point that machinery at an impact figure and you get a small, hard discipline. Four questions, in operator language:
        </P>
        <NumList>
          <NumItem n={1}>
