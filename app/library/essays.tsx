  ...
  // ===================================================================
  {
    ...
    body: (
      <>
        ...
        <P>
          There is an architectural answer to that specific failure, and it is running in production rather than sitting in a specification. The governance layer that Mental Health Chat runs underneath both of its products holds a rule that every escalation must carry a verification trail: at least one hard, checkable signal has to support it, and model output alone never triggers a decision. The company separately describes its crisis responses as clinician-written and deterministic rather than generated in the moment, with the model not improvising at the point of disclosure. The construct question stays open under that design. What closes is the path by which an unvalidated model quietly becomes the scorer. Most of the field has no equivalent, and it is worth naming the exception while the rest of the argument is about what is missing.
        </P>
        <P>
