  ...
  // ===================================================================
  {
    ...
    body: (
      <>
        ...
        <P>
          Good arithmetic can sit on a weak inference. Any return built by summing pathways is only as sound as its softest pathway &mdash; and summing is the operation that lets a strong pathway carry a weak one across the finish line. The total reads healthy while one of its parts is doing work the evidence can&rsquo;t support. The number isn&rsquo;t wrong. It&rsquo;s un-audited in the one place that decides whether it&rsquo;s real.
        </P>
        <P>
        ...
        <P>
          The rigor is real. The place these claims actually break sits one layer down, in the composite itself: all of that rigor still resolves into a single reported magnitude, and contribution (additionality, the &ldquo;would this have happened anyway&rdquo; question) is the one link a blended ratio is built to hide. The rigor went in. The composite let it back out.
        </P>
        <P>
