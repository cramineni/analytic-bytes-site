...
export const ESSAYS: Essay[] = [
  ...
  // ===================================================================
  {
    ...
    body: (
      <>
        <P>
          <I>A response to <B>&ldquo;Dollars in Pockets: A New Way to Measure What Matters&rdquo;</B> &mdash; NextLadder Ventures &amp; GitLab Foundation, July 2026.</I>
        </P>
        ...
        <P>
          It was not for lack of trying. The field already had shared vocabularies &mdash; the GIIN&rsquo;s IRIS+ catalog of standardized impact metrics, and SROI&rsquo;s older tradition of monetizing outcomes into a return ratio. But IRIS+ is a menu of indicators, not a single convertible number, and SROI produced a ratio without ever settling what the ratio was denominated in. Both got close to comparability and stopped just short of a common unit. That last step is the one Dollars in Pockets actually takes.
        </P>
        <P>
        ...
        <P>
          Take the piece&rsquo;s own worked example, Rasa Legal, whose tool helps people clear eligible criminal records. Its Dollars in Pockets figure sums three pathways: legal fees avoided, wage gains that follow a cleared record, and savings from reduced housing instability. Look at the three side by side and they are not equally certain. Fees avoided is close to immediate and direct &mdash; the record is cleared, the fee is not paid. But &ldquo;wage gains that follow a cleared record&rdquo; and &ldquo;savings from more stable housing&rdquo; each depend on a chain of contribution holding: that the clearance causes the job, that the job causes the housing, and that none of it would have happened anyway. Those are the softer links. Sum the three into one figure and the near-certainty of pathway one quietly underwrites the causal reach of pathways two and three. The composite can&rsquo;t tell you which pathway is load-bearing on the weakest inference. That isn&rsquo;t a flaw in Rasa Legal; it&rsquo;s a property of adding.
        </P>
        <P>
        ...
        <NumList>
          ...
          <NumItem n={3}>
            <B>Reflects what matters</B> &mdash; does the thing measured stand in for the outcome we actually care about?
          </NumItem>
          <NumItem n={4}>
        ...
        <P>
          It is worth naming what this is not. The responsible-AI frameworks a fund is likeliest to reach for &mdash; NIST&rsquo;s AI Risk Management Framework, the EU AI Act&rsquo;s risk tiers &mdash; govern, map, measure, and manage, but none of them contains a validity inference: a test of whether the number actually supports the claim being made on it. That absence is not unique to impact capital. It is the same missing link, surfacing wherever a number is asked to justify a decision. The gate here is one instance of a discipline the whole responsible-measurement conversation is still missing.
        </P>

        <H2>Validity tells you which verb the number earned</H2>
        <P>
          This is where a validity lens stops being a brake and starts being useful. Additionality is the whole game &mdash; and the impact field already knows it: the Impact Management Project&rsquo;s five dimensions name <I>contribution</I> as a dimension in its own right, the one that asks whether the change would have happened anyway. Dollars in Pockets&rsquo; own counterfactual work is precisely what pays that dimension off and earns the strong verb. So the discipline isn&rsquo;t there to slow the claim down; it&rsquo;s there to tell a fund, honestly, how much weight a given number can carry:
        </P>
        <P>
        ...
        <P>
          That is not a hedge. &ldquo;Here is our return, and here is exactly how much of it we can stand behind, and where it&rsquo;s thin&rdquo; is a stronger thing to say to a skeptical LP than a bigger number with no gate under it. Validity is what holds up when someone leans on it.
        </P>
        ...
        <P>
          There is a reason to build the reflex now, while Dollars in Pockets is still a voluntary standard. Mandating a measure does not make it valid. India&rsquo;s regulated regime already runs the experiment: Section 135 of the Companies Act requires third-party CSR impact assessment, and the SEBI Social Stock Exchange requires audited annual impact reports on a logic-model frame &mdash; and the early read is that regulation forces the <I>production</I> of impact numbers without forcing the <I>quality</I> of the inference behind them. A common unit will spread faster than the discipline to audit it. The gate is cheapest to install before the number is everywhere.
        </P>
        <P>
          This continues a line already drawn &mdash; that reach is not outcome, that numbers which don&rsquo;t reconcile can&rsquo;t all be true. A magnitude, however rigorously built, is not yet a validity. The impact field needs a sounder path from the number to the claim, with the weak link surfaced early, while it&rsquo;s still cheap to fix.
        </P>
  ...
  // ===================================================================
  {
    ...
    body: (
      <>
        ...
        <P>
          The field has been candid about this for fifteen years. In 2010 the National Institute of Mental Health published its Research Domain Criteria framework with a one-sentence diagnosis of why a new framework was needed: the weakness of the DSM is its lack of validity. The standard mental-health diagnoses, unlike definitions of ischemic heart disease or lymphoma or AIDS, are based on consensus about clusters of clinical symptoms, not an objective laboratory measure. Twelve years later Thomas Insel, who led NIMH during the period he is critiquing, wrote in <I>Healing</I> that the research had largely failed to help Americans struggling with mental illness despite billions of dollars directed into it. The Lancet Commission on Global Mental Health and Sustainable Development in 2018 reframed the field at a global-public-good scale, with a projected sixteen-trillion-dollar cost by 2030 measured against a construct whose foundations remained partly underdetermined. The WHO has made the same point. None of these are fringe positions. They are the field&rsquo;s most authoritative voices saying, on the record, that the underlying construct on which mental health AI tools now make their measurement claims is in active contestation.
        </P>
        <P>
        ...
        <P>
          The cost calculus is the second reason validity has to hold in mental health in a way it may not need to in other AI domains. The cost of measuring the wrong thing in administrative AI shows up as a wrong scholarship decision, a wrong advising flag, a wrong staffing recommendation. The cost of measuring the wrong thing in mental health AI shows up as a wrong crisis-detection call for an adolescent who needed it, a missed signal in someone with intent, a chatbot response that reinforced isolation when connection would have helped, an AI companion that taught a vulnerable user a pattern of relating that diminished rather than supported their self-efficacy and locus of control. The most vulnerable users &mdash; adolescents, people in active crisis, those without access to traditional clinical support &mdash; are the populations most likely to use consumer-facing AI mental-health tools, the populations whose construct presentations are most heterogeneous, and the populations for whom the validity case is thinnest. They bear the cost of the validity gap. The demographic evidence is already visible in the data. Roughly one in eight US adolescents have used AI for mental-health advice; Black youth are 5.45 times more likely than White youth to use it at least monthly, girls twice as likely as boys, and 63 percent told no one they were doing it (<a href="https://www.ajmc.com/view/ai-chatbot-use-for-mental-health-advice-rises-sharply-among-us-youth-with-key-disparities-identified" target="_blank" rel="noopener" className="text-accent hover:text-accent-2 no-underline border-b border-line-2 hover:border-accent pb-px">JAMA Pediatrics, June 2026</a>).
        </P>
        <P>
          The canonical mechanism is documented. Obermeyer and colleagues in <I>Science</I> in 2019 showed a widely used healthcare algorithm affecting millions of patients had been predicting healthcare costs as a proxy for illness. The proxy reproduced the structural inequity in spending patterns, so Black patients turned out to be considerably sicker than White patients at the same risk score. Remedying the proxy would have increased the percentage of Black patients receiving additional help from 17.7 percent to 46.5 percent. The mechanism is a validity failure: the proxy did not represent the construct the system claimed to track. The mental-health version of the same mechanism, deployed at the scales the consumer-facing AI tools now operate at, is the case now unfolding in the field.
        </P>
        <P>
          So what does the responsible-AI rubric need underneath it. The answer is not another principle or another commitment added to the list of six or eight or ten, but a prior layer, asked first, before any of the rubric&rsquo;s other questions can be evaluated. Four questions constitute the validity layer that the rubric depends on.
        </P>
        <P>
        ...
        <P>
          This is offered as the prior discipline the responsible-AI rubrics assume, and as recognition that the rubrics are doing the right work at the right altitude. Lumara&rsquo;s five questions are the right responsible-AI floor. So are the NAM Code of Conduct&rsquo;s six commitments, the APA&rsquo;s ethical guidance, the WHO workshop&rsquo;s three recommendations, the Polaris Principles, the VERA-MH evaluation work, the ASL-MH framework. All of these are necessary. None of them is sufficient if the validity question is not answered first.
        </P>
        <P>
