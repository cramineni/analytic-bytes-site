...
export const ESSAYS: Essay[] = [
  ...
  // ===================================================================
  {
    ...
    readingTime: "14 min read",
    summary:
      "The evaluation report arrives after the cohort has passed. The dashboard arrives after the event, and no layer carries its warrant. Between the two there is nothing an organisation can act on and defend. A validated link between an early signal and a later outcome should be treated as infrastructure: the semantic layer carries the claim, the evidence and date behind it, and when it must be rechecked.",
    ...
    body: (
      <>
        ...
        <P>
          Both organisations have an evaluation function. Both have a reporting function. Neither can act this quarter on a number it could also defend. That is the gap this essay is about, and I want to be careful about what it is not. It is not the gap Rashi Trivedi describes in <a href="https://www.linkedin.com/pulse/impact-decision-gap-rashi-trivedi-xyexf/" target="_blank" rel="noopener" className="text-accent hover:text-accent-2 no-underline border-b border-line-2 hover:border-accent pb-px"><I>The Impact Decision Gap</I></a>, where good evidence arrives and the decision was already made. It is not the loop-ownership gap in <InternalLink slug="four-jobs-one-loop">Four jobs, one loop</InternalLink>. It is a gap in time. The evidence that would answer the question exists at two moments, and neither moment is the one the decision is made in.
        </P>
        ...
        <MetaNote>
          Written September 2026 for the Analytic Bytes Library. The eight job postings were captured between May and 14 September 2026 and are held as snapshots in the piece&rsquo;s source pack. Seven of the eight organisations are not named; GitLab Foundation is named because <InternalLink slug="the-valid-dollar">The valid dollar</InternalLink> had already written about its metric. The two organisations in the opening and the reporting prototype are from the author&rsquo;s own record and are not named. The J-PAL quotation was checked against the playbook&rsquo;s full text, and the Brainard piece against the published article; the simulation named in the AI section is logged in the AB idea log and has not been built.
        </MetaNote>
      </>
    ),
  },
