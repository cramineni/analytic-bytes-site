...
export const ESSAYS: Essay[] = [
  ...
  // ===================================================================
  {
    ...
    body: (
      <>
        <P>
          A round of frameworks for governing AI in mental health has appeared in the last twenty months. <a href="https://www.lyrahealth.com/blog/the-polaris-principles/" target="_blank" rel="noopener" className="text-accent hover:text-accent-2 no-underline border-b border-line-2 hover:border-accent pb-px">Lyra Health&rsquo;s Polaris Principles</a> articulated the industry-side posture. The <a href="https://nam.edu/our-work/programs/leadership-consortium/health-care-artificial-intelligence-code-of-conduct/" target="_blank" rel="noopener" className="text-accent hover:text-accent-2 no-underline border-b border-line-2 hover:border-accent pb-px">National Academy of Medicine published its AI Code of Conduct for Health and Medicine</a> in May 2025 with six commitments including monitoring performance. The American Psychological Association (APA) released ethical guidance for AI in health service psychology in 2025 and followed with a 2026 health advisory whose plain-language judgment about consumer AI in mental health was blunt: the chatbots and wellness apps lack the testing and safety measures needed for quality mental health support. VERA-MH (Validation of Ethical and Responsible AI in Mental Health) appeared as an open-source AI safety evaluation built around conversation simulation and clinician judging. ASL-MH (AI Safety Levels for Mental Health) proposed AI safety levels for mental health applications. The WHO convened an expert workshop on responsible AI for mental health in January 2026 with explicit recommendations about embedding mental health into AI impact assessments. Lumara published a five-question rubric for evaluating any AI mental-health tool before deployment &mdash; clear, operator-grade, structured so a clinical lead or a foundation program officer can use it in a procurement conversation. The rubrics are necessary. This essay credits the work being done and names the layer the rubrics do not yet include.
        </P>
        <P>
