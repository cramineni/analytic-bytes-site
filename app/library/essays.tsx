  ...
  // ===================================================================
  {
    ...
    body: (
      <>
        ...
        <MetaNote>
          Written September 2026 for the Analytic Bytes Library. No employer, client, authorizer or funder is named; every seat is described by role and in de-identified form, per standing practice. The opening reconciliation and the inside-or-outside discriminator are from the author&rsquo;s own record. External sources were verified against their live pages in September 2026, and the verification log, text snapshots and review rounds are held in the piece&rsquo;s source pack. One claim was cut rather than carried: how many states require classroom observations was not checkable at reasonable cost, and the argument does not need it.
        </MetaNote>
      </>
    ),
  },
