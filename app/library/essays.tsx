  ...
  // ===================================================================
  {
    ...
    body: (
      <>
        ...
        <P>
          I have sat in the access half of that seat, for a benefit claim rather than a risk claim. I ran data for a K-8 charter network, and the question was whether we were reaching the children who needed us. Two of the districts we had moved into were sixteen to seventeen percent English learners; we were serving five percent. I had the desk and I could see the pipeline. What I did not have was acceptance criteria: what reaching them would mean, measured how, by when. The seat existed because someone had hired for it. It had nothing to check against, so access on its own did not settle the claim. An AI deployment making the same reach claim would sit in the same seat, with the model version added to the things that can shift underneath.
        </P>
        <P>
          That is the state of the benefit side now. The harm side is getting the seat by commitment, in writing, at two labs, as a condition of proceeding. The benefit side has seats: the evaluation a funder requires, the measurement person a school network happened to hire. But each of those exists because someone chose to pay for it. A funder can require an evaluation or not; a network can hire the measurement person or not; and a program can say <I>this helped</I> either way. On the risk side, under the pacing plan, a model does not move past capability X until an evaluator has checked, and the check is the price of moving. That is the difference. The benefit side has the seat as an option. It does not have the seat as a condition of making the claim.
        </P>
        <P>
