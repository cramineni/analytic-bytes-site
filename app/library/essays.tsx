    ...
    body: (
      <>
        <Brief>
          ...
          <p>
            I have held that seat in four organizations, and each placement broke the loop in a different place. This note is about what breaks, which split does the breaking, and what to ask of a requisition or a grantee to find out.
          </p>
        </Brief>
        ...
        <P>
          No, because there are two different axes you can cut on. One cut splits the four jobs from each other: design into research, dashboards into operations, the funder report into development, revision into nobody. That is the split that breaks the loop. The other cut splits the function from the programs it measures: all four jobs stay in one charter, and that charter reports outside the teams whose numbers it audits. That is the split that protects the loop.
        </P>
        <P>
