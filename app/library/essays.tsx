    ...
    body: (
      <>
        <Brief>
          ...
          <p>
            A measurement function has four jobs. The first is to design what to collect, against the claims it will have to support. The second is to analyze so the people running the program can act this month. The third is to analyze so a funder gets a claim they can check. The fourth is to revise the measurement for the next round. The fourth feeds the first, and a reporting function never runs it.
          </p>
          <p>
        ...
        <NumList>
          ...
          <NumItem n={2}>
            <B>Analyze so it serves operations.</B> The people running the program can act on the result this month. A no-show pattern a clinician can read; a cohort a state team can call.
          </NumItem>
          <NumItem n={3}>
