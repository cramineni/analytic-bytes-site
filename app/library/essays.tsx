  ...
  // ===================================================================
  {
    ...
    body: (
      <>
        ...
        <P>
          That is the state of the benefit side now. The harm side is getting the seat by commitment, in writing, at two labs, as a condition of proceeding. The benefit side has seats: the evaluation a funder requires, the assessment and accountability lead a school network hires, the compliance officer a clinic keeps for the auditor. But each of those exists because someone chose to pay for it. A funder can require an evaluation or not; a network can hire the assessment lead or not; a clinic can keep the compliance officer or not; and a program can say <I>this helped</I> either way. On the risk side, under the pacing plan, a model does not move past capability X until an evaluator has checked, and the check is the price of moving. That is the difference. The benefit side has the seat as an option. It does not have the seat as a condition of making the claim.
        </P>
        <P>
