    ...
    body: (
      <>
        <Brief>
          ...
          <p>
            This essay makes that case from two organizations, eight job postings already hiring for the seat, and Kane&rsquo;s argument-based approach to validity. It ends with three fields to write on any metric that is being read as if it said something about an outcome.
          </p>
        </Brief>
        ...
        <P>
          Organizations are already hiring for the join, even where nobody has written down what the join is. Eight postings since May, seven of them captured this week, describe the seat. Four are worth reading closely.
        </P>
        <P>
        ...
        <P>
          The objection is that this is a rich organization&rsquo;s problem. A foundation with a data science team can afford a ladder of outcomes and a recheck schedule. A homeless-services agency with nine hundred staff and a $140 million budget cannot, and should keep its evaluation function and its reporting function and get on with the work.
        </P>
        <P>
        ...
        <P>
          Data infrastructure and AI make the everyday work cheap: collecting the data, building the dashboard, drafting the report. <InternalLink slug="four-jobs-one-loop">Four jobs, one loop</InternalLink> already argues that cheaper production does not supply an owner for the reasoning around it. I will not repeat that here. What this essay adds is narrower: how often the link can be re-established.
        </P>
        <P>
        ...
        <MetaNote>
          Written September 2026 for the Analytic Bytes Library. The eight job postings were captured between May and 14 September 2026 and are held as snapshots in the piece&rsquo;s source pack. Seven of the eight organizations are not named; GitLab Foundation is named because <InternalLink slug="the-valid-dollar">The valid dollar</InternalLink> had already written about its metric. The two organizations in the opening and the reporting prototype are from the author&rsquo;s own record and are not named. The J-PAL quotation was checked against the playbook&rsquo;s full text, and the Brainard piece against the published article; the simulation named in the AI section is logged in the AB idea log and has not been built.
        </MetaNote>
      </>
    ),
  },
