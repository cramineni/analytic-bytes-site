  ...
  // ===================================================================
  {
    ...
    body: (
      <>
        ...
        <P>
          It can be filled in badly, and that is the argument for making it a field rather than a principle. Someone will write <I>owns data strategy</I>. You can hold that against the bar and watch it fail, because owning an area is not settling a question, and then you can ask for a better line. A principle cannot fail that way. <I>Organizations should be clear about decision rights</I> is something a reader agrees with and puts down. A field is something a reader has to fill, and a filled field can be wrong in public.
        </P>
        <P>
